...
export default function FloatingControls() {
  ...
  // Track scroll position to conditionally show scroll-to-top button
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className="floating-controls-wrapper">
      ...
      <button 
        className={`floating-btn theme-toggle-btn ${isDarkMode ? "dark-active" : ""}`}
      ...
      >
        {isDarkMode ? (
          ...
          // Crescent Moon Icon shown in light mode (exact thin stroke outline!)
